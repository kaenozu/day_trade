...
# -*- coding: utf-8 -*-
"""
Real Data Provider V2 - Configuration Manager
リアルデータプロバイダー V2 - 設定管理
...
class DataSourceConfigManager:
    ...
    def update_config(self, source_name: str, **kwargs):
        """設定更新"""
        ...
        for key, value in kwargs.items():
            if hasattr(config, key):
                ...
                self.logger.info(f"Updated {source_name}.{key} = {value}")
            else:
    ...
    def reset_to_defaults(self):
        ...
        self.logger.info("Reset configurations to defaults")
