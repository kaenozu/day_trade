...
from .types import GPUInferenceConfig, TENSORRT_AVAILABLE, PYNVML_AVAILABLE
from ...utils.logging_config import get_context_logger

logger = get_context_logger(__name__)

# TensorRT関連のインポート (フォールバック対応)
if TENSORRT_AVAILABLE:
    import tensorrt as trt

# PyCUDA関連のインポート (フォールバック対応)
try:
    ...
    logger.warning("PyCUDA not available - TensorRT推論制限")
