"""
ML データ処理と特徴量エンジニアリング

ml_prediction_models_improved.py からのリファクタリング抽出
データ準備パイプライン、データプロバイダー、特徴量エンジニアリング機能
"""
...
# 設定とエラーのインポート
from .ml_config import DataQuality, PredictionTask, TrainingConfig
from .ml_exceptions import DataPreparationError
...
class DataPreparationPipeline:
    ...
    def __init__(self, config: Optional[TrainingConfig] = None):
        ...
        self.scaler = StandardScaler() if SKLEARN_AVAILABLE and self.config.enable_scaling else None
