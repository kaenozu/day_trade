...
class FeatureStore:
    ...
    def load_feature(
        ...
        try:
            ...
            logger.info("特徴量キャッシュから読み込み完了", extra={
        ...
        for symbol in symbols:
            ...
            try:
                ...
                feature_result = self.get_or_generate_feature(
                    symbol, data, start_date, end_date, feature_config, optimization_config
                )
        ...
        return {
            **self.stats,
            ...
            'avg_generation_time_ms': round(
                (self.stats['total_generation_time'] / max(1, self.stats['features_generated'])) * 1000, 2
            ),
            'avg_loading_time_ms': round(
                (self.stats['total_loading_time'] / max(1, self.stats['features_loaded'])) * 1000, 2
            )
        }
