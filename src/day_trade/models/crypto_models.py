...
from sqlalchemy import Column, DateTime, String, Integer, Numeric, Text, Boolean, JSON, Index
...
class CryptoWhaleTransaction(Base):
    ...
    # 分類・重要度
    transaction_type = Column(String(50), nullable=True)  # exchange_inflow, exchange_outflow, wallet_to_wallet
