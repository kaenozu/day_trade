...
# -*- coding: utf-8 -*-
"""
Performance Config Manager - 性能監視設定管理

MLモデル性能監視システムの設定を管理するモジュール
外部YAMLファイルからの設定読み込みとデフォルト設定の提供
"""
...
class EnhancedPerformanceConfigManager:
    ...
    性能監視システムの設定を管理し、外部設定ファイルからの
    動的設定読み込みをサポートします。
    
    Attributes:
        config_path: 設定ファイルのパス
        config: 読み込まれた設定データ
        last_loaded: 最終読み込み時刻
    """
    ...
    def __init__(self, config_path: Optional[Path] = None):
        ...
        Args:
            config_path: 設定ファイルのパス（未指定時はデフォルトパス）
        """
        self.config_path = (
