...
from src.day_trade.config.config_loader import ConfigLoader, get_config_loader, load_integrated_config
    ...
    try:
        ...
        if "symbols" in watchlist:
            ...
            for field in required_fields:
                assert field in first_symbol, f"銘柄データに必須フィールド '{field}' が不足"
