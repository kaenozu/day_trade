...
class TestPredictionOrchestrator:
    ...
    def test_generate_enhanced_prediction_with_ml(self, orchestrator_with_ml, sample_data):
        """機械学習ありでの統合予測生成テスト"""
        # ML予測のモック
    ...
    def test_risk_factors_identification(self, orchestrator_no_ml, sample_data):
        ...
        with patch.object(
            ...
            prediction = orchestrator_no_ml.generate_enhanced_prediction(low_liquidity_data)
    ...
    def test_prediction_uncertainty_calculation(self, orchestrator_with_ml, sample_data):
        """予測不確実性計算テスト"""
        # 分散の大きいML予測を設定
        orchestrator_with_ml.ml_manager.models = {
        ...
        with patch.object(
            ...
            orchestrator_with_ml.model_weights = {"model1": 0.3, "model2": 0.4, "model3": 0.3}
    ...
    def test_system_status_reporting(self, orchestrator_no_ml):
        ...
        assert config["prediction_horizon"] == orchestrator_no_ml.config.prediction_horizon
    ...
    def test_prediction_history_management(self, orchestrator_no_ml, sample_data):
        ...
        with patch.object(
            ...
            # 履歴が増加していることを確認
            assert len(orchestrator_no_ml.prediction_history) == initial_history_length + 3
