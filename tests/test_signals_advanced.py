...
class TestTradingSignalAdvanced:
    ...
    def signal_generator(self, mock_config):
        ...
        return TradingSignalGenerator(mock_config)

    def test_calculate_confidence_score_with_strength_multipliers(self, signal_generator, sample_data):
        """信頼度計算で強度調整係数のテスト"""
        # STRONG信号の作成
        ...
        confidence = signal_generator._calculate_confidence_score(
    ...
    def test_calculate_confidence_score_with_weak_signal(self, signal_generator):
        """WEAK信号での信頼度計算テスト"""
        signal = TradingSignal(
        ...
        confidence = signal_generator._calculate_confidence_score(signal)

        # WEAK信号は0.8倍される
        expected_base = signal.confidence * 0.8
        assert abs(confidence - expected_base) < 0.1

    def test_calculate_confidence_score_with_volatile_market(self, signal_generator):
    ...
    def test_calculate_confidence_score_trend_following(self, signal_generator):
    ...
    def test_calculate_confidence_score_trend_reversal_penalty(self, signal_generator):
    ...
    def test_calculate_confidence_score_with_historical_performance(self, signal_generator):
    ...
    def test_calculate_confidence_score_with_historical_performance_no_success_column(self, signal_generator):
    ...
    def test_calculate_confidence_score_multi_condition_bonus(self, signal_generator):
        """複数条件ボーナスのテスト"""
        # 3つの条件を満たすシグナル
        ...
        confidence_multi = signal_generator._calculate_confidence_score(signal_multi)
        ...
        confidence_two = signal_generator._calculate_confidence_score(signal_two)

        # 3条件の方がボーナスが大きい
        assert confidence_multi > confidence_two

    def test_calculate_confidence_score_empty_historical_performance(self, signal_generator):
        """空の履歴データでの信頼度計算テスト"""
        signal = TradingSignal(
            signal_type=SignalType.BUY,
            strength=SignalStrength.MEDIUM,
...
class TestTradingSignalGeneratorExtended:
    ...
    def extended_generator(self, mock_config):
        """TradingSignalGeneratorExtendedインスタンス"""
        return TradingSignalGeneratorExtended(mock_config)
...
class TestSignalValidationAdvanced:
    ...
    def test_complex_market_context_validation(self, mock_config, sample_data):
        """複雑な市場環境での検証テスト"""
        generator = TradingSignalGenerator(mock_config)
    ...
    def test_performance_based_confidence_adjustment(self, mock_config):
        ...
        confidence_high = generator._calculate_confidence_score(
        ...
        confidence_low = generator._calculate_confidence_score(
