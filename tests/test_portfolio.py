...
from src.day_trade.core.portfolio import (
    PortfolioAnalyzer, PortfolioMetrics, SectorAllocation, PerformanceReport
)
from src.day_trade.core.trade_manager import TradeManager, TradeType, Position
...
class TestPortfolioAnalyzer:
    ...
    def test_calculate_volatility_with_mock_data(self):
        ...
        mock_data = pd.DataFrame({
            'Close': [2500 + i * 10 + (i % 5) * 20 for i in range(30)]
        }, index=dates)
