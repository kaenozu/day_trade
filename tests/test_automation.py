...
class TestConfigManager:
    ...
    def test_config_manager_initialization(self):
        ...
        with patch("builtins.open", mock_open(read_data=config_json)), patch(
    ...
    def test_config_validation_empty_symbols(self):
        ...
        with patch("builtins.open", mock_open(read_data=config_json)), patch(
            ...
            ValueError, match="ウォッチリストに監視銘柄が一つも設定されていません"
        ):
            ConfigManager("test_config.json")
...
class TestDayTradeOrchestrator:
    ...
    def test_run_full_automation_basic(self, mock_stock_fetcher, mock_config_manager):
        ...
        mock_config_instance.get_technical_indicator_settings.return_value = Mock(
            enabled=False
        )
        mock_config_instance.get_pattern_recognition_settings.return_value = Mock(
            enabled=False
        )
        mock_config_instance.get_signal_generation_settings.return_value = Mock(
            enabled=False
        )
        ...
        mock_stock_instance.get_current_price.return_value = {
            "current_price": 2500,
            "volume": 1000000,
        }
    ...
    def test_execution_result_creation(self):
        ...
        result = ExecutionResult(
            success=True, symbol="7203", data={"price": 2500}, execution_time=1.5
        )
    ...
    def test_config_to_orchestrator_integration(self, mock_open_func, mock_exists):
        ...
        test_config = {
            ...
            "alerts": {
                ...
                "volume_alerts": {"enabled": False},
                "technical_alerts": {"enabled": False},
