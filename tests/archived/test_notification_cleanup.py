...
try:
    ...
    from src.day_trade.risk_management.factories.alert_factory import (
        NotificationChannelType,
    )
    from src.day_trade.risk_management.interfaces.alert_interfaces import (
        NotificationChannel as InterfaceNotificationChannel,
    )
...
class TestNotificationChannelCleanup(unittest.TestCase):
    ...
    def test_alert_factory_notification_channel_types(self):
        ...
        for channel_type in removed_types:
            self.assertNotIn(
                channel_type, actual_types, f"{channel_type} should be removed"
            )
