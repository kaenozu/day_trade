...
class PerformanceBenchmarkSuite:
            ...
            for data_size in test_data_sizes:
                ...
                result = BenchmarkResult(
                    ...
                    metadata={
                        ...
                        "memory_per_point": (
                            memory_usage / data_size if data_size > 0 else 0
                        ),
                    },
                )
                ...
                print(
                    f"    データサイズ {data_size}: {total_time:.3f}秒, {throughput:.1f} indicators/sec"
                )
    ...
    def benchmark_deep_learning_system(self) -> List[BenchmarkResult]:
        ...
        for data_size in test_data_sizes:
            ...
            # モデル登録
            from src.day_trade.ml import LSTMModel, TransformerModel
        ...
        bottlenecks = {
            "performance_bottleneck": {
                ...
                "avg_execution_time": statistics.mean(
                    component_stats[slowest_component]["execution_times"]
                ),
                "impact": "high",
            },
            "memory_bottleneck": {
                ...
                "avg_memory_usage": statistics.mean(
                    component_stats[memory_heaviest]["memory_usage"]
                ),
                "impact": "medium",
            },
            "reliability_bottleneck": {
                ...
                "impact": (
                    "high"
                    if statistics.mean(component_stats[error_prone]["error_rates"])
                    > 0.1
                    else "low"
                ),
            },
        ...
        for component in comparison:
            for opt_level in comparison[component]:
                ...
                comparison[component][opt_level] = {
                    ...
                    "avg_throughput": (
                        statistics.mean(stats["throughput"])
                        if stats["throughput"]
                        else 0
                    ),
                    "avg_memory_usage": (
                        statistics.mean(stats["memory_usage"])
