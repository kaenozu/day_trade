...
class SimpleAPMTest:
    ...
    def test_config_files_existence(self) -> bool:
        ...
        try:
            ...
            self.log_test_result("設定ファイル存在確認", success, {
            ...
            self.log_test_result("設定ファイル存在確認", False, {
                "error": str(e),
    ...
    def test_observability_modules_import(self) -> bool:
        ...
        try:
            ...
            self.log_test_result("監視モジュールインポート", success, {
            ...
            self.log_test_result("監視モジュールインポート", False, {
                "error": str(e),
                "traceback": traceback.format_exc()
            })
            return False
    ...
    def test_dashboard_generation_basic(self) -> bool:
        ...
        try:
            ...
            dashboard_info = {
                ...
                "file_size": test_dashboard_path.stat().st_size if test_dashboard_path.exists() else 0,
            ...
            self.log_test_result("基本ダッシュボード生成", False, {
                "error": str(e),
                "traceback": traceback.format_exc()
            })
            return False
    ...
    def test_slo_config_validation(self) -> bool:
        ...
        try:
            ...
            validation_results = {
                ...
                "all_slos_have_targets": all("target_percentage" in slo for slo in slo_config["slos"]),
                "all_slos_have_queries": all("sli_query" in slo for slo in slo_config["slos"]),
                "config_size_bytes": slo_config_path.stat().st_size if slo_config_path.exists() else 0
            }
            ...
            self.log_test_result("SLO設定検証", False, {
                "error": str(e),
                "traceback": traceback.format_exc()
            })
            return False
    ...
    def test_docker_compose_validation(self) -> bool:
        ...
        try:
            ...
            if not docker_compose_path.exists():
                self.log_test_result("Docker Compose設定検証", False, {
            ...
            if success:
                print(f"  [OK] Docker Compose検証成功: {validation_results['services_found']}/{validation_results['services_expected']} services found")
            else:
                print(f"  [FAIL] Docker Compose検証失敗")
