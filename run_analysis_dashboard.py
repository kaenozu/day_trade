...
def main():
    """メイン実行関数"""
    print("=" * 80)
    print("🔒 Day Trade 分析専用ダッシュボード起動")
    print("=" * 80)

    # セーフモード確認
    if not is_safe_mode():
        print("❌ エラー: セーフモードが無効です")
    ...
    print("✅ 分析・教育・研究専用システムとして起動します")
    print("=" * 80)
    print("🌐 ダッシュボードURL: http://localhost:8000")
    print("📊 API ドキュメント: http://localhost:8000/docs")
    print("🔍 システム状態: http://localhost:8000/api/system/status")
    print("=" * 80)
    print("⚠️  重要事項:")
